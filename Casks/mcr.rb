cask "mcr" do
  version "0.3.4"
  sha256 "1277ecd03989ca4b0bbe9328a1589bcf57acce14516fbeee6d498633a4a7b085"

  url "https://github.com/mayckol/mcr/releases/download/v#{version}/MCR_0.3.4_aarch64.dmg"
  name "MCR"

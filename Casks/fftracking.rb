cask "fftracking" do
  version "1.0.15"
  sha256 "5b38dec3935c987c205399df6a330b5e1b5fbde562561161329b24e51a877ddf"

  url "https://github.com/mayckol/fftracking/releases/download/v#{version}/fftracking_1.0.15_aarch64.dmg"
  name "fftracking"

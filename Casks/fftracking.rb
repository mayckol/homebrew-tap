cask "fftracking" do
  version "1.0.25"
  sha256 "897d9534cbab58b1689d57f85599f79c354cdbbc8fdb0c06c2b9e6db4a00275a"

  url "https://github.com/mayckol/fftracking/releases/download/v#{version}/fftracking_1.0.25_aarch64.dmg"
  name "fftracking"

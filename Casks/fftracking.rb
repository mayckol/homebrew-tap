cask "fftracking" do
  version "1.0.1"
  sha256 "0a831fb6ffac649474829bc4e3b903479cf245a5ed7d986f85205eaed8e2e34e"

  url "https://github.com/mayckol/fftracking/releases/download/v#{version}/fftracking_1.0.1_aarch64.dmg"
  name "fftracking"

cask "fftracking" do
  version "1.0.4"
  sha256 "b7f290db447702d0b4b394d0b9daeb1ffcce94d4130a7ac4a2a212c22e0ffe97"

  url "https://github.com/mayckol/fftracking/releases/download/v#{version}/fftracking_1.0.4_aarch64.dmg"
  name "fftracking"

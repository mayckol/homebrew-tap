cask "fftracking" do
  version "1.0.8"
  sha256 "39fdee90216e4c2e378d2a4fb04ff8faa3ff90aba42288b0a09b7e2f867bd092"

  url "https://github.com/mayckol/fftracking/releases/download/v#{version}/fftracking_1.0.8_aarch64.dmg"
  name "fftracking"

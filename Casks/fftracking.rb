cask "fftracking" do
  version "1.0.0"
  sha256 "397c0205c25a617219f1ee6aee085aa242eec57a8214d99a3f0a318db4022fac"

  url "https://github.com/mayckol/fftracking/releases/download/v#{version}/fftracking_1.0.0_aarch64.dmg"
  name "fftracking"

cask "fftracking" do
  version "1.0.21"
  sha256 "c8e6a0130571f8bfedc80df4a8a56ffb04066d5f508dc004938567ca4c92415e"

  url "https://github.com/mayckol/fftracking/releases/download/v#{version}/fftracking_1.0.21_aarch64.dmg"
  name "fftracking"

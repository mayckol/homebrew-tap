cask "fftracking" do
  version "1.0.9"
  sha256 "db3689d1c230c312c0453895a3a56411ceef39e847c276c628d190bbee09909c"

  url "https://github.com/mayckol/fftracking/releases/download/v#{version}/fftracking_1.0.9_aarch64.dmg"
  name "fftracking"
